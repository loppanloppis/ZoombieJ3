...
class plgZoombieFileBackup extends JPlugin {
    ...
    protected function sendFile() {
        ...
        $toemail = $fromemail;
        $subject =  'FileBackup Zoombie Task : ' . $config->get('config.sitename');
        ...
        $attachment = JPATH_SITE . '/plugins/zoombie/filebackup/backup/filebackup.' . $config->get('config.sitename') . '_' . $date . '.zip';
